...
impl App {
    pub(crate) fn handle_action(&mut self, action: Action) {
        ...
        match action {
            ...
            Action::ScrollHalfDown => self.scroll_doc_by_fraction(2, true),
            Action::ScrollHalfUp => self.scroll_doc_by_fraction(2, false),
            Action::ScrollPageDown => self.scroll_doc_page(true),
            Action::ScrollPageUp => self.scroll_doc_page(false),
