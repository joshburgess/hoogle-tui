...
- Haddock parser fixture coverage includes representative value and type declaration pages, source links, since annotations, warning blocks, tables, details, definition lists, module links, anchor links, and rich inline markup.
...
2. Add parser fixtures for constructor/record-field subdocumentation if the UI starts surfacing those as separate navigable entries.
