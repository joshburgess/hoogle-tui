...
Set `RUN_AUDIT=1` to include a RustSec dependency audit with `cargo-audit`.
The default suite also checks formatting, tests, clippy, rustdoc, library crate packaging, prose style, app-module imports, dead-code allowances, and panic-prone or unfinished calls in shipped Rust code.
