...
The default suite also checks formatting, tests, clippy, prose style, app-module imports, dead-code allowances, and panic-prone or unfinished calls in shipped Rust code.
